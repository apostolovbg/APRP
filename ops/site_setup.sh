...
site_setup_main() {
  ...
  local site_name="${SITE_NAME:?SITE_NAME is required}"
  local app_name="${APRP_APP_NAME:?APRP_APP_NAME is required}"
  local db_host="${DB_HOST:?DB_HOST is required}"
  local db_port="${DB_PORT:?DB_PORT is required}"
  local bootstrap_db_host="${BOOTSTRAP_DB_HOST:?BOOTSTRAP_DB_HOST is required}"
  local bootstrap_db_port="${BOOTSTRAP_DB_PORT:?BOOTSTRAP_DB_PORT is required}"
  ...
  local redis_cache="${REDIS_CACHE:?REDIS_CACHE is required}"
  local redis_queue="${REDIS_QUEUE:?REDIS_QUEUE is required}"
  local redis_socketio="${REDIS_SOCKETIO:?REDIS_SOCKETIO is required}"
