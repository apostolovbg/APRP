...
class TestAprpRuntime(unittest.TestCase):
    ...
    def test_runtime_files_refer_to_the_aprp_hosts(self):
        ...
        self.assertIn("/opt/aprp/checkout", runtime_text)
        ...
        self.assertIn("/opt/aprp/checkout", system_text)
        ...
        self.assertIn("/opt/aprp/checkout", install_text)
        ...
        self.assertIn("/opt/aprp/checkout", security_text)
